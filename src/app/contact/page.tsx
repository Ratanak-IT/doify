...
import {
  MessageSquare, Send, ExternalLink, HelpCircle, MapPin, Mail, Clock,
  AlertTriangle, Twitter, Linkedin, Instagram,
} from "lucide-react";
...
export default function ContactPage() {
  ...
  const faqs = [
    { q: "How do I submit a proposal?",     a: 'Open the job details page and click "Submit Proposal".' },
    { q: "Why is my account restricted?",   a: "Check your email or contact support for verification issues." },
    { q: "How do I report a scam job?",     a: 'Click "Report Job" on the job detail page.' },
  ];

  const contactInfo = [
    { icon: <Mail size={14} />,  dot: "bg-blue-500",    label: "Email",          value: "support@doify.com" },
    { icon: <Clock size={14} />, dot: "bg-emerald-500", label: "Response time",  value: "24–48 hours" },
    { icon: <MapPin size={14} />, dot: "bg-violet-500", label: "Location",       value: "Phnom Penh, Cambodia" },
  ];
  ...
  // Google Maps embed — Science and Technology Advanced (ISTAD), Phnom Penh
   const mapEmbedSrc = "https://maps.google.com/maps?q=11.585256,104.901402&hl=en&z=16&output=embed";
  const mapsLink = "https://www.google.com/maps/place/Science+and+Technology+Advanced+Development+Co.,+Ltd./@11.585256,104.901402,15z/data=!4m6!3m5!1s0x310951e96d257a6f:0x6b66703c5fc0c7cc!8m2!3d11.585256!4d104.9014024";
    ...
    <div className="font-sans bg-slate-50 dark:bg-slate-950 text-slate-950 dark:text-white min-h-screen">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-slate-950 dark:text-white mb-3">
          Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6c47ff] to-pink-500">touch</span> with us
        </h1>
        ...
        >
          {submitted ? (
            <div className="text-center py-14 px-6">
              ...
              <h3 className="text-lg font-bold mb-2 text-slate-950 dark:text-white">Message sent!</h3>
            ...
            <>
              ...
              <div className="flex items-start gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-950 dark:text-white">Send us a Message</h2>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">We&apos;ll get back to you soon</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                <div>
                  <label className="block text-sm font-semibold mb-1.5 text-slate-950 dark:text-white">Name</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-semibold mb-1.5 text-slate-950 dark:text-white">Email</label>
                  <input
                    className={fieldInput}
                    type="email" name="email" value={form.email}
                    onChange={handleChange} placeholder="johnsmith@gmail.com"
                  />
                </div>
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-semibold mb-1.5 text-slate-950 dark:text-white">
                  Company <span className="font-normal text-slate-400 dark:text-slate-500">(optional)</span>
                </label>
                <input
                  className={fieldInput}
              ...
              {/* Message */}
              <div className="mb-5">
                <label className="block text-sm font-semibold mb-1.5 text-slate-950 dark:text-white">Message</label>
                <textarea
              ...
              >
                {!canSubmit && <AlertTriangle size={15} />}
                <Send size={15} />
                Send Message
              </button>
        ...
        <div className="flex flex-col gap-5 sm:gap-6">
          ...
          >
            ...
            <a
              ...
              className="absolute top-3 left-3 z-10 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm text-xs font-semibold text-[#6c47ff] hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
            >
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-base font-bold text-slate-950 dark:text-white">Quick Answer</h3>
            </div>

            <div className="space-y-4 divide-y divide-slate-100 dark:divide-slate-800">
              {faqs.map((f, i) => (
                <div key={i} className={i > 0 ? "pt-4" : ""}>
                  <h4 className="text-sm font-bold text-slate-950 dark:text-white mb-1">{f.q}</h4>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 sm:p-7"
          >
            <h3 className="text-base font-bold text-slate-950 dark:text-white mb-4">Contact</h3>
            ...
            <ul className="space-y-3">
              {contactInfo.map((c) => (
                <li key={c.label} className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-slate-950 dark:text-white font-medium break-all">{c.value}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="mt-5 pt-5 border-t border-slate-100 dark:border-slate-800">
              <p className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-3">Follow us</p>
