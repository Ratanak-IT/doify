    ...
    <footer className="bg-white dark:bg-[#1a1c2e] border-t border-slate-200 dark:border-[#2a2d45] text-slate-500 dark:text-slate-400 pt-10 sm:pt-14 pb-6 sm:pb-8 px-4 sm:px-8 transition-colors">
      <div className="max-w-5xl mx-auto mb-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-md leading-relaxed text-slate-500 dark:text-slate-400 max-w-[220px]">
            Simplifying teamwork and productivity for everyone, everywhere.
          </p>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-[1fr_1fr] gap-8">
          <div>
            ...
            <ul className="flex flex-col gap-2.5">
              <li>
                <Link
                  href="/about"
                  className="text-lg text-slate-500 dark:text-slate-400 hover:text-violet-600 transition-colors"
                >
                  About Us
                </Link>
              </li>
      ...
      <div className="max-w-5xl mx-auto flex items-center justify-between flex-wrap gap-2">
        <span className="text-md text-slate-400 dark:text-slate-600">
