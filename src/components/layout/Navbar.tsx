...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <nav className="fixed top-0 left-0 right-0 z-100 transition-all duration-300 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/20 dark:border-slate-700/50 shadow-lg">
