      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full h-10 px-3 rounded-xl border text-sm outline-none bg-white dark:bg-slate-800 dark:text-white transition-colors ${
              errors.name
                ? "border-red-400"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-sm outline-none focus:border-violet-500 bg-white dark:bg-slate-800 dark:text-white resize-none transition-colors"
          />
        </div>
